...
export const updateReaction = async(
    ...
    if (prevType === validatedReactionType) {
        await reactionCollection.deleteOne({_id: reactionItem._id});

        // Decrement comment likes/dislikes count
        const counterKey = `stats.${validatedReactionType}s`;
...
export const deleteReaction = async(id) => {
    const errorSource = 'createReaction';
